                    ...
                    <li class="dropdown"><a href="#"><i class="icon-layers mr-1"></i> Web Apps</a>                  
                        <ul>
                            ...
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Leave Application</a>
                                <ul class="sub-menu">
                                    <li><a href="{{route('leave_show')}}"><i class="icon-energy"></i> My Leave Application</a></li>
                                    @if(Auth::user()->role_id == 11 || Auth::user()->role_id == 2 || Auth::user()->role_id == 3 || Auth::user()->role_id == 36)
                                    <li><a href="{{route('leave_teamshow')}}"><i class="icon-energy"></i> Team Leave Application</a></li>
                                    @endif

                                    @if(Auth::user()->role_id == 11 || Auth::user()->role_id == 36)
                                    <li><a href="{{route('all_leave_application')}}"><i class="icon-energy"></i> All Leave Applications</a></li>
                                    @endif
                            ...
                            <li><a href="{{route('blogs_index')}}"><i class="icon-tag"></i> Blogs</a></li>
                            <li><a href="{{route('reviews_index')}}"><i class="icon-tag"></i> Reviews</a></li>
