...
<input type="hidden" name="user_id" value="{{Auth::user()->id}}">        
        <div class="modal-body">
                    <h4>Is this a full-time or part-time job? </h4>
...
<!-- Include details  -->
      <div class="row-1">
        ...
        <div class="app-setting-blk">         
            <ul>
            <li><p><h5>Is this a full-time or part-time job?<a href="#myModa005" data-target="#myModa005" data-toggle="modal"><i class="fa fa-pencil" aria-hidden="true"></i></a></h5></p></li>
            <li>{{$job->part_time}}</li>
